...
// Import Protobuf framework
// - SPM: SVGA_USE_SPM=1, uses ProtobufObjC.xcframework
// - CocoaPods: uses Protobuf pod
// - Build script: uses direct include
#if SVGA_USE_SPM
#import <ProtobufObjC/GPBProtocolBuffers.h>
#elif __has_include(<Protobuf/GPBProtocolBuffers.h>)
